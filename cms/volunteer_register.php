<?php
session_start();
require 'db.php'; // Use InfinityFree database connection
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM volunteers WHERE volunteer_email = ?");
...
<head>
    ...
    <style>
        ...
        .login-box button {
            ...
            border: none;
            border-radius: 12px;
            background-color: rgb(245, 194, 143);
            color: black;
            font-size: 18px;
            font-weight: bold;
            cursor: pointer;
    ...
    <div class="login-box">
        ...
        <form method="post">
            ...
            <div class="register-line">
                You haven't registered? <a href="volunteer_register.php">Register</a>
            </div>
